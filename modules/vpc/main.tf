# Separate Public and Private into separate AZs
...
# SG to allow HTTP connections from anywhere
...
# SG to onlly allow SSH connections from VPC public subnets to private EC2 at the backend
